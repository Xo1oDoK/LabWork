...
namespace LabaratorWork.ViewModel
{
   public  class DataManageVM : INotifyPropertyChanged
    {
        ...
        private void OpenAddProductWindow()
        {
            ...
            AddNewProject addProduct = new AddNewProject();
            ...
            get
            {
                return editSelectedProduct ?? new RelayCommand(obj =>
                {
                    ...
                    if (SelectedProduct != null)
                    {
                        ...
                        {
                            OpenMessageWindow("Не корректные данные, поле не может быть пустым или превышать кол-во в 50 символов");
                        }
                        else
                        {
